...
export default {
  ...
  data() {
    return {
      ...
      books: [
        { title: "Self-Reliance", author: "Ralph Waldo Emerson", finishedReading: true, ownership: [],},
        { title: "American Gods", author: "Neil Gaiman" , finishedReading: false, ownership: [],},
        { title: "Amusing Ourselves to Death", author: "Neil Postman", finishedReading: true, ownership: [],},
      ]
    };
  },
  components: {
